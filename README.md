[![React App CI](https://github.com/KarriSpandana/ci-cd-with-actions/actions/workflows/ci.yml/badge.svg)](https://github.com/KarriSpandana/ci-cd-with-actions/actions/workflows/ci.yml)
